...
| 手工测试版 | `manual-v0.7.2-beta.5` / `d48eeb0` | 已发布，未使用 Actions |
| 当前发布候选 | `manual-v0.7.2-beta.6` | 修复 Windows 私有仓库列表 UTF-8 读取，并校正发布冒烟测试 |
| Python 包版本 | `0.7.2b6` | Beta 6 候选 |
| 当前自动测试 | 125 项 | 全部通过 |
...
已有仓库选择和安全连接已进入 Beta 4。自适应、高对比度向导滚动条已完成代码和专项测试，等待进入 Beta 5 安装包。
